...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Platform.runLater(this::endConnection);
    }
    ...
    private void saveCache(String nickname) throws IOException {
    ...
    private void loadCache(String nickname) throws IOException {
        file = new File(String.format
                ("src/main/resources/client/%s.txt", nickname));
        ...
        if (msgCache.size() > msgs) {
            for (int i = msgCache.size()-msgs; i <= msgCache.size() - 1; i++) {
                textArea.appendText(msgCache.get(i) + "\n");
            }
        } else {
    ...
    private void setTitle (String name) {
        Platform.runLater(() -> ((Stage)textField.getScene().getWindow()).setTitle(TITLE + " " + name));
    }
